...
insert into Sessao (id, idZona, idCidade) values (sequence_zona.nextVal, 1, 1); 
insert into Sessao (id, idZona, idCidade) values (sequence_zona.nextVal, 2, 2); 
...
insert into UrnaEleicaoCargo (urna, eleicao, cargo, brancos, nulos) values (1, 1, 1, 1000, 50); 
insert into UrnaEleicaoCargo (urna, eleicao, cargo, brancos, nulos) values (2, 2, 2, 20000, 700); 
...
insert into Pleito (urna, candidatura, quantidade) values (1, 1, 666);
insert into Pleito (urna, candidatura, quantidade) values (2, 2, 999);
...
insert into Intencao (candidatura, DataInicio, DataFim, quantidade) values (2, TO_DATE('02-01-2014', 'dd-mm-yyyy', TO_DATE('01-05-2014', 'dd-mm-yyyy'), 3000);
